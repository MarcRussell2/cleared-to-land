...
async function flyInPage(html, port = 9751, ids = null, seed = 307) {
  ...
  const edge = spawnProcess('C:/Program Files (x86)/Microsoft/Edge/Application/msedge.exe', ['--headless=new', '--hide-scrollbars', '--allow-file-access-from-files', '--window-size=960,540', `--remote-debugging-port=${port}`, `--user-data-dir=${profile}`, 'about:blank'], { stdio: 'ignore' });

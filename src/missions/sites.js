...
// src/art/airport-look.js: 'kestrel' | 'paradise' | 'frostbite') and `surroundings` ({roads: [[u0, v0, u1, v1,
// width]], villages: [[u, v, count, spread]]} in the runway frame, instead of the default roads and villages).
...
const KESTREL_RW = {
  ...
  props: 'kestrel',
  surroundings: {
    roads: [[-250, -1100, -250, 1100, 6], [-250, 260, 420, 110, 5], [705, -900, 690, 900, 5]],
...
const PARADISE_RW = {
  ...
  props: 'paradise',
  surroundings: {
    roads: [[-34, -1700, -34, 1700, 8], [-34, 700, 2700, 700, 7], [1334, 700, 1334, 372, 6], [-34, -700, 1500, -800, 6]],
...
export const NEW_SITES = {
  ...
  redmesa: {
    ...
    terrain: {
      ...
      desert: {
        floor: -150, butte: 190,
        mesa: { u0: -30, u1: 820, half: 175, round: 110, wobble: 45, calm: 140 },
